          ...
          <div className="portfolio-list">
            ...
            <div className="img-card-container">
              <div className="img-card" onClick={() => handleModal('modal1')}>
                ...
                <div className="info">
                  <h3>SmartWrist</h3>
                  <span>An E-commerce platform for high-quality smartwatches</span>
                </div>
                ...
                <div className={`modal ${modals.modal1 ? 'show active portfolio-model flex-center' : 'hide portfolio-model flex-center'}`} >
                  <div className="portfolio-model-body">
                    ...
                    <p>The premier online destination for purchasing high-quality smartwatches. This platform offers a wide selection of the latest and greatest smartwatch models, from the most popular brands in the industry. With our user-friendly interface, you can easily browse, compare, and purchase smartwatches to meet your needs and style. With three categories for men, women, and kids, SmartWrist has something for everyone! </p>
                    <br />
                    <h4><a  href="https://e-commerce-app-rosy-three.vercel.app/" target="_blank" rel="noreferrer">Live Demo   </a><i className="fas fa-long-arrow-alt-right"></i></h4>
                  </div>
                </div>
            </div>
              ...
              <div className="img-card" onClick={() => handleModal('modal2')}>
                ...
                <div className={`modal ${modals.modal2 ? 'show active portfolio-model flex-center' : 'hide portfolio-model flex-center'}`} >
                  <div className="portfolio-model-body">
                    ...
                    <p>This E-commerce API simplifies online store management with basic CRUD operations for products and a cart feature for easy checkout. This API enables you to manipulate product information such as stock and user data, making it a flexible tool for businesses of all sizes. Whether you're managing inventory or updating user data, this E-commerce API provides the functionality you need to grow your online store.</p>
                    <br />
                    <h4><a  href="https://dashboard.render.com/web/srv-cg5eaa7dvk4pls4j358g" target="_blank" rel="noreferrer">Live Demo   </a><i className="fas fa-long-arrow-alt-right"></i></h4>
                  </div>
                </div>
            </div>
            ...
            <div className="img-card-container">
              <div className="img-card" onClick={() => handleModal('modal4')}>
                ...
                <div className={`modal ${modals.modal4 ? 'show active portfolio-model flex-center' : 'hide portfolio-model flex-center'}`} >
                  <div className="portfolio-model-body">
                    <i className="fas fa-times portfolio-close-btn" onClick={handleCloseModals}></i>
                    <h3>Keeper</h3>
            ...
            <div className="img-card-container">
              <div className="img-card" onClick={() => handleModal('modal5')}>
                ...
                <div className={`modal ${modals.modal5 ? 'show active portfolio-model flex-center' : 'hide portfolio-model flex-center'}`} >
                  <div className="portfolio-model-body">
                    <i className="fas fa-times portfolio-close-btn" onClick={handleCloseModals}></i>
                    <h3>To-Do List</h3>
